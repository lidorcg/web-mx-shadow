(ns todomvc.todo-view
  (:require [clojure.string :as str]
            [goog.dom :as dom]
            [goog.dom.classlist :as classlist]
            [goog.dom.forms :as form]
            [todomvc.todo :refer [td-completed td-delete!
                                  td-title
                                  td-toggle-completed!]]
            [tiltontec.matrix.api :refer [cF]]
            [tiltontec.model.core :refer [mset!] :as md]
            [tiltontec.util.core :as util]
            [tiltontec.web-mx.api :refer [button div input input-editing-start
                                          label li]]))
